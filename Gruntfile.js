module.exports = function (grunt) {
    ...
    grunt.registerTask('locale', ['eslint:locale', 'clean:locale', 'copy:locale', 'uglify:locale']);
    grunt.registerTask('plugin', ['eslint:plugin', 'clean:plugin', 'concat:plugin', 'uglify:plugin', 'jsduck']);
    grunt.registerTask('styles', ['clean:styles', 'less', 'cssmin']);
    grunt.registerTask('default', ['docs', 'locale', 'plugin', 'styles', 'update_json']);
    grunt.registerTask('travis', ['locale', 'eslint:plugin', 'clean:plugin', 'concat:plugin', 'uglify:plugin', 'styles']);
